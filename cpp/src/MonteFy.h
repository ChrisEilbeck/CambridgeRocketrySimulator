	...
	class MonteFy
	{
		...
		public:
				...
				double CoPm;					// centre of pressure, std [m]
				double CNm;						// normal coefficient, std
				double CDdm;					// drag coefficient for the secondary+ parachute, std
				double CDpm;					// drag coefficient for the primary parachute, std
				double sigmaLaunchDeclination;	// stochastic variable for launch angle
				double sigmaThrust;				// stochastic variable for thrust
