	...
	if(myfile.is_open())
	{
		while(!myfile.eof())
		{
			...
			for(int i=0;i<11;i++)
			{
				...
				switch(i)
				{
					case 0:		time.push_back(fnum);						break;
					case 1:		Thrust.push_back(fnum);						break;
					case 2:		Mass.push_back(fnum);						break;
					case 3:		Ixx.push_back(fnum);						break;
					case 4:		Iyy.push_back(fnum);						break;
					case 5:		Izz.push_back(fnum);						break;
					case 6:		Ixy.push_back(fnum);						break;
					case 7:		Ixz.push_back(fnum);						break;
					case 8:		Iyz.push_back(fnum);						break;
					case 9:		Xcm.push_back(fnum);						break;
					case 10:	Cda1.push_back(fnum);						break;
					default:	cout<<"Error in case number for intab1\n";
				}
			}
		}
	...
	if(myfile.is_open())
	{
		while(!myfile.eof())
		{
			...
			if(i==0)
				...
				cout<<"Error too much data in INTAB3 file\n";
	...
	if(myfile.is_open())
	{
		while(!myfile.eof())
		{
			...
			for(int i=0;i<6;i++)
			{
				...
				switch(i)
				{
					case 0:		Alt.push_back(fnum);						break;
					case 1:		Wx.push_back(fnum);							break;
					case 2:		Wy.push_back(fnum);							break;
					case 3:		Wz.push_back(fnum);							break;
					case 4:		rho.push_back(fnum);						break;
					case 5:		temp.push_back(fnum);						break;
					default:	cout<<"Error in case number for intab1\n";
				}
			}
		}
